...
import featuresFlagConfig from '@/config/features-flag.config';
 ...
 */
export const priority = featuresFlagConfig.languagePriority;
...
export function getLanguageOrFallback(language: string | undefined) {
